...
function NetherGemCatalyst(input, output) {
  ...
  StrengthenedCatalyst('forge:raw_materials/silver', 'thermal:silver_dust')
	...
	StrengthenedCatalyst('forge:raw_materials/osmium', 'mekanism:dust_omsium')
  ...
  SimpleGemCatalyst('forge:ores/flourite', 'mekanism:flourite_geme')
  SimpleGemCatalyst('forge:ores/redstone', 'minecraft:redstone_dust')
